...
export const TRAIT_CATEGORIES: TraitCategory[] = [
  {
    ...
    options: [
      ...
      { id: "pink", label: "pink", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to pastel pink. DO NOT add any new fur, fluff, halo, mane, background pink, or decorative pink elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "blue", label: "blue", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to pastel sky blue. DO NOT add any new fur, fluff, halo, mane, background blue, or decorative blue elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "grey", label: "grey", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to soft light grey. DO NOT add any new fur, fluff, halo, mane, background grey, or decorative grey elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "mint", label: "mint", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to pale mint green. DO NOT add any new fur, fluff, halo, mane, background green, or decorative green elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "lavender", label: "lavender", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to pale lavender purple. DO NOT add any new fur, fluff, halo, mane, background purple, or decorative purple elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "yellow", label: "yellow", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to soft pastel yellow. DO NOT add any new fur, fluff, halo, mane, background yellow, or decorative yellow elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
      { id: "black", label: "black", prompt: "recolour the existing white fur pixels on the shiba (body, muzzle, cheeks, legs, paws, chest — every area that is white in the reference) to matte black. DO NOT add any new fur, fluff, halo, mane, background black, or decorative black elements behind or around the character. The orange face-mask markings, orange ear tips, and all orange parts stay EXACTLY the same orange as the reference. The background stays pure white" },
    ],
  },
  {
    id: "suitColor",
